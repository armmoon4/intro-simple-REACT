 ...
 const handleRemoveFavorite = (itemId, itemPrice) => {
  ...
  return (
    <>
      ...
      <div className="main-container flex text-center ml-74">

        <div className="left-container max-w-7xl mx-2 px-8 sm:px-12 lg:px-16">
          <Items key={handleItem.id} handleItem={handleItem}></Items>
        </div>

        <div className="right-container w-[30%]">

          <div className=" rounded-2xl shadow-lg p-6 w-full max-w-sm mx-auto font-sans">

            {/* Header */}
            <div className="flex items-center mb-6 border-b pb-4">
              {/* Inlined Heart Icon SVG */}
            ...
            <div className="space-y-4">
...

              {
                markItem.map((marked) => <div key={marked.id} className="flex items-center pb-4 border-b border-gray-100">
                  ...
                  <img src={marked.image} alt="Electric Guitar" className="w-16 h-16 rounded-lg object-cover" />
